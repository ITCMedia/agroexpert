            ...
            <div class="row no-gutters">
                <div class="card-deck infographic__block">
                    ...
                    <div class="card w-30 infographic-item down-shadow__block">
                        ...
                        <div class="card-body">
                            <p class="title">
                                Сохранение здоровья и продление жизни<br> животных и птицы
                            </p>
                            <div class="description">
                ...
                <div class="col-xl-12">
                    <div id="zavod" class="zavod__info">
                        ...
                        <p>Комбикормовый завод «Агро-эксперт»<br>
                            Лидер отрасли 2018 Инновационное производство, оснащенное современным оборудованием<br> и
            ...
            <div class="row">
                <div class="col-xl-7 col-lg-7 col-md-7">
                    <div id="products" class="products__left">
                        <h2>Комбикорма</h2>
                        <p>Для изготовления продукции используется только отборное сырье. Перед отправкой на обработку
                            мы тщательно исследуем его цвет, вкус и запах, считаем долю
                            влаги.</p>
                    </div>
                </div>
